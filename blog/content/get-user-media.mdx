...
แต่ปัญหามันอยู่ที่ว่า Standalone PWA บน iOS เนี่ยมันดันไม่ support การถ่ายรูปเฉยเลย... ซึ่งเป็นมาตั้งแต่ iOS 11.3.1 แล้วพึ่งจะมาแก้ใร iOS 13.4 ที่พึ่งจะออกมา~ เลยถือโอกาส update ครั้งนี้แหละ จะได้ใช้กล้องบน iOS PWA ได้ซักที!
...
## หยุดเก็บรูปได้แล้วน่า~
แน่นอนว่า พอเราได้ร๔ปที่ต้องการแล้ว เราก็อยากที่จะหยุดบันทึกกล้องได้แล้วเนอะ~ ไม่งั้นคงจะทั้งเปลืองแบตแล้วก็คงไม่มีใครอยากเห็นหน้าตัวเองบนเว็บตลอดเวลาที่ใช้หรอก จริงไหม?
