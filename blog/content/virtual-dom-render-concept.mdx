...
จากนั้นก็ loop key ของ object ที่ถูกเก็บเป็น object มาเพื่อเขียบลง attributes อีกทัี
```javascript
typeof element[property] === "object"
    ? Array.apply(
            false,
...
พอเราได้ชื่อ property มาแล้วการสามารถใช้ reference นี้ในการกหา property ได้
```javascript
typeof element[property] === "object"
    ? Array.apply(
            false,
