...
<Divider />
<Blockquote author="อ้างอิงจาก React 16.9">
...
<Image src="/assets/content/preact-3kb-of-react/big-ecosystem.png" alt="React has big ecosystem" />
...
<Image src="/assets/content/preact-3kb-of-react/lighthouse.png" alt="Google's Lighthouse" />

# ขนาดของ React ใหญ่เกินไป
<Image src="/assets/content/preact-3kb-of-react/too-large.png" alt="React is too large" />
...
library ที่ยกตัวอย่างด้านบนมาใช้ preact-compat แล้วใช้ library ของ React เหมือนเดิมได้เลย (ยกเว้น SSR)
...
<Image src="/assets/content/preact-3kb-of-react/preact-vs-react.png" alt="Preact vs React on Google Firebase" />
