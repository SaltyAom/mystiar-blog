...
## Diffing
แน่นอนว่าถึงเราจะมี Object ขึ้นมาแล้ว เราจะเปรียบเทียบ Object 2 อันนีเได้ยังไง? แน่นอนว่าเราก็ต้องเขียนขึ้นเพื่อหาเอง ศึ่งเราเรียกขั้นตอนนี้ว่าการ Diffing
...
ซึ่งเพื่อลดขั้นตอนความยุ่งยากโดยการเปลี่ยนมาใช้ createElement แทน
```javascript
