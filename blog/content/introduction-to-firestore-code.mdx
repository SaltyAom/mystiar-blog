...
ต่อจากพาร์ทที่แล้วที่เราได้รู้วิธีการสร้างโปรเจค Firebase, เปิดใช้งาน Firestore และก็สร้าง Connection ครั้งนี้เรามีลองใช้คำสั่งของ Firestore กันดีกว่า~
สำหรับใครที่ยังไม่ได้อ่านบทก่อนหน้าก็แนะนำให้ลองอ่านดูก่อนเพื่อความครบถ้วนของเนื้อหานะ~

<MarkedContent
    title={Blog['introduction-to-firestore'].meta.title}
    author={Blog['introduction-to-firestore'].meta.author}
    cover={Blog['introduction-to-firestore'].meta.cover}
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/hatsune-miku.jpg"
...
<Image
    src="/assets/content/introduction-to-firestore-code/store.png"
    alt="เห็นภาพมะ? เพราะมันเป็นภาพไง"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-model.png"
    alt="Firestore Model"
/>
...
```javascript
collection('store').document('Hatsune Miku')
```
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-collection.jpg"
    alt="Firestore Collection"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/console-collection-id.jpg"
    alt="Collection ID"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-named-collection.jpg"
    alt="Named Collection"
/>
<Divider />
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-get-data.jpg"
    alt="Firestore get data"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-no-data.jpg"
    alt="Firestore no data"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-updated.jpg"
    alt="Updated Firestore"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-deleted.jpg"
    alt="Deleted"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/realtime-changed.jpg"
    alt="Realtime Changed"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-nested-model.png"
    alt="Firestore Nested Model"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-multiple-model.jpg"
    alt="Multiple Model"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-value.jpg"
    alt="Firestore value"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/where-length.jpg"
    alt="Where length"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/order-by.jpg"
    alt="Order by"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/limit-result.jpg"
    alt="Limit result"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/start-at.jpg"
    alt="Start at"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/end-at.jpg"
    alt="End at"
/>
<Divider />
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-index.jpg"
    alt="Firestore Index"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-create-index.jpg"
    alt="Firestore Create Index"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-index-creation.jpg"
    alt="Firestore Index Creation"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/firestore-persistance.jpg"
    alt="Firestore Persistance"
/>
...
<Image
    src="/assets/content/introduction-to-firestore-code/transaction-failure.jpg"
...
<Image
    src="/assets/content/introduction-to-firestore-code/transaction-completed.jpg"
...
<Image
    src="/assets/content/introduction-to-firestore-code/batch-commited.jpg"
    alt="Batch Commited"
/>
