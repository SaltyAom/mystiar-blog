...
แต่ปัญหาคือ ใยบางครั้งเราก็ต้องการใช้ State Manager แค่นิดเดียว ใช้ Concept ง่ายๆ แค่การแชร์ค่าตัวแปร แต่เรากลับต้องมาตั้ง Boilerplate เยอะแยะ ทั้งๆ ทำให้เสียเวลาจนหัวเสีย อีกทั้งส่วนที่เราไม่ใช้กลับต้อง Build เข้า Production ทำให้ขนาดไฟล์มันใหญ่ขึ้นไปเยอะทั้งๆ ที่เราไม่ได้ใช้ด้วยซ้ำ
...
<Image src="/assets/content/introduction-to-arkflows/grani.jpeg" alt="Whoa Reaction" />
...
<Image src="/assets/content/introduction-to-arkflows/angery.gif" alt="Angry" />
...
Ps. ชื่อ Arkflows มาจากการที่คนเขียนติดเกมที่ชื่อว่า Arknights เลยเอาคำว่า Ark มานำหน้าแล้วเติมคำว่า Flow ซึ่งแทนถึงการไหลเวียนของข้อมูล เลยได้ชื่อเท่ๆ ออกมา เจ๋งดีใช่ไหมละ ／人◕ ‿‿ ◕人＼